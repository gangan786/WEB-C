    ...
    <form id="form1" runat="server">
       <div>
            <table class="auto-style1">
                <tr>
                    <td class="auto-style2" style="float: right; clear: right;">用户名：</td>
                ...
                <tr>
                    <td class="auto-style2" style="float: right; clear: right;">密码：</td>
                    <td class="auto-style3">
                ...
                <tr>
                    <td class="auto-style2" style="float: right; clear: right;">确认密码：</td>
                    <td class="auto-style3">
                ...
                <tr>
                    <td class="auto-style2" style="float: right; clear: right;">生日：</td>
                    <td class="auto-style3">
                ...
                <tr>
                    <td class="auto-style2" style="float: right; clear: right;">电话号码：</td>
                    <td class="auto-style3">
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="revTelephone" runat="server" ControlToValidate="txtTelephone" Display="Dynamic" ErrorMessage="电话号码格式应为：021-66798304！" SetFocusOnError="True" ValidationExpression="\d{3}-\d{8}" ValidationGroup="groupSubmit"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2" style="float: right; clear: right;">身份证号：</td>
                    <td class="auto-style3">
                    ...
                    <td>
                        ...
                        <asp:CustomValidator ID="csvIdentity" runat="server" ControlToValidate="txtIdentity" Display="Dynamic" ErrorMessage="身份证号错误" OnServerValidate="csvIdentity_ServerValidate" SetFocusOnError="True" ValidationGroup="groupSubmit"></asp:CustomValidator>
                    </td>
                </tr>
            </table>
        </div>
